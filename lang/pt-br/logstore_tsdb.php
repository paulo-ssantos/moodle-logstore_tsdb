...
$string['connectionfailed_title'] = 'Falha na Conexão com TimescaleDB';
$string['connectionfailed_details'] = 'Detalhes da Conexão:';
$string['connectionfailed_tryagain'] = 'Tentar Novamente';
$string['connectionfailed_setuplater'] = 'Configurar Depois';
